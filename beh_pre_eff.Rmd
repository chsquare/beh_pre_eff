...
```{r Figure 3, fig.cap="Figure 3. Fixed effect coefficients of the maximum identified linear mixed model on response times (Model 2). Effect contrasts are given in brackets next to the names of main effects on the y-axis. In-Up: Inverted minus upright; Inv-Val: Invalid minus valid."}
...
```{r Figure 5, fig.cap="Figure 5. Fixed effect coefficients of the maximum identified generalized linear model on task errors (Model 6). Effect contrasts are given in brackets next to the names of main effects on the y-axis. In-Up: Inverted minus upright; Inv-Val: Invalid minus valid."}
